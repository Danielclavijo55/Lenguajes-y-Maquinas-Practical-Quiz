...
ArrayList names = new  ArrayList <Integer>();
  ...
  final public void vert() throws ParseException {
 Object v;
    v = id();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 16:
...
names.add(v);
  ...
  final public Object id() throws ParseException {
 Object o;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NAME:
      o = name();
  ...
  final public void d_id() throws ParseException, Error {
 Object o;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NAME:
      o = name();
  ...
  final public Integer num() throws ParseException, Error {
    ...
    token = jj_consume_token(NUMBER);
                ...
                {if (true) return new Integer(total);}
    throw new Error("Missing return statement in function");
  }
